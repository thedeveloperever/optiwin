...
echo.
echo              %COL%[33m[%COL%[37m 7 %COL%[33m]%COL%[37m Disable HDCP %HDCOF%              %COL%[33m[%COL%[37m 8 %COL%[33m]%COL%[37m Disable Preemption %CMAOF%        %COL%[33m[%COL%[37m 9 %COL%[33m]%COL%[37m ProfileInspector %NPIOF%
...
echo.
echo              %COL%[33m[%COL%[37m 10 %COL%[33m]%COL%[37m Disable Nvidia Telemetry %NVTOF%  %COL%[33m[%COL%[37m 11 %COL%[33m]%COL%[37m Nvidia Tweaks %NVIOF%           %COL%[33m[%COL%[37m 12 %COL%[33m]%COL%[37m Disable Write Combining %DWCOF%
...
if /i "%choice%"=="7" goto Mitigations
if /i "%choice%"=="X" exit /b
if /i "%choice%"=="B" goto MainMenu
...
if "%NPIOF%" == "%COL%[91mOFF" (
	...
	powershell curl -o $Env:SystemDrive\OptiWin\Resources\nvidiaProfileInspector.zip https://github.com/Orbmu2k/nvidiaProfileInspector/releases/download/2.4.0.4/nvidiaProfileInspector.zip
        powershell -NoProfile Expand-Archive -Force $Env:SystemDrive\OptiWin\Resources\nvidiaProfileInspector.zip -DestinationPath $Env:SystemDrive\OptiWin\Resources\nvidiaProfileInspector\
